class VerticalStackInCard extends HTMLElement {
    ...
    setConfig(config) {
        ...
        if (config.title) {
            ...
            title.style = "font-family: var(--paper-font-headline_-_font-family); color: var(--ha-card-header-color, --primary-text-color); -webkit-font-smoothing: var(--paper-font-headline_-_-webkit-font-smoothing); font-size: var(--paper-font-headline_-_font-size); font-weight: var(--paper-font-headline_-_font-weight); letter-spacing: var(--paper-font-headline_-_letter-spacing); line-height: var(--paper-font-headline_-_line-height);text-rendering: var(--paper-font-common-expensive-kerning_-_text-rendering);opacity: var(--dark-primary-opacity);padding: 24px 16px 0px 16px";
